		...
		switch($step)
		{
			...
			case 'viewdashboard':
				...
				if($count > 0){	
					...
					$_SESSION['Message'] = 'deact_acct';
				}						

			    if($login_flag){
				//	$redirect_to = FOLDER_PATH_HTTP.'social-followers.php';								
				  $redirect_to = FOLDER_PATH_HTTP.'help.php';
				   $user_object 	= $s123_customer_manager->getSingleS123CustomerWithUsername($where_clause);
			...
			case 'forgot_password':
				...
				$sample_link = FOLDER_PATH_HTTP.'index.php';
								 ...
								 <tr>
									<td align="left"  valign="top">
									 ...
									 <table width="700px" border="0" cellspacing="5" cellpadding="2" >                        
										...
										<tr>
										  <td align="left" valign="top">Dear "'.ucfirst($first_name).'",</td>
									   </tr>
										<tr>
